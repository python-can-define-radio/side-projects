...
def visualize(
    ...
    cmap_norm = None
    if norm == "log":
        cmap_norm = LogNorm(vmin=1e-4, vmax=0.2)          # ADDED 2025-11-25
...
grid[50, 80, 0] = fdtd.PointSource(
    period = 60, name="source1"  # type: ignore
)
...
# from fdtdtest import grid, visualize
...
## some thing(s) that might be nice to try:
### - remove an object from grid.objects
