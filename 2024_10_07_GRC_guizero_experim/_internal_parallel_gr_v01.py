...
class PGR_basicsourcesinkwater:
    ...
    def set_freq(self, freq: float) -> None:
        ...
        self.__pgr.put_cmd(PGR_basicsourcesinkwater._set_freq_child, freq)


class xsquaredgrapher:
    def __init__(self) -> None:
        # from turtle import Turtle
        global scale
        scale = 1.0
...
class P_turtle_xsquared:
    def __init__(self) -> None:
        self.__pg = ParallelGeneral(xsquaredgrapher, update_graph_loop)

    def start(self) -> None:
        self.__pg.start()

    @staticmethod
    def _set_scale_child(xsg: xsquaredgrapher, scale_toset: float) -> None:
        global scale
        scale = scale_toset
